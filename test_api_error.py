...
def test_instagram_gif():
    ...
    # Increase timeout to 300 seconds (5 minutes) for video processing
    client = VideoServicesClient(timeout=300.0)
    ...
    try:
        ...
        # Save the GIF for verification
        with open("test_output.gif", "wb") as f:
            f.write(gif_bytes)
        print("Saved GIF to test_output.gif")
