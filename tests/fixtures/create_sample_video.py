...
def create_sample_video(
    output_path: str = "sample_video.mp4", duration: int = 5
) -> bool:
    ...
    try:
        ...
        cmd = [
            ...
            "lavfi",
            "-i",
            f"color=c=blue:s=320x240:d={duration}",  # Blue color, 320x240, 5 seconds
            "-f",
            "lavfi",
            "-i",
            f"sine=frequency=1000:duration={duration}",  # 1kHz sine wave audio
            "-vcodec",
